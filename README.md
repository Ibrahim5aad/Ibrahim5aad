...
I am Ibrahim Saad, an Software Engineer from Egypt, based in Prague, Czechia. 👨‍💻
...
- 🔧 [XbimGeometry](https://github.com/Ibrahim5aad/XbimGeometry/tree/native-engine) — porting the xbim Geometry Engine from C++/CLI to a cross-platform C/P-Invoke architecture
